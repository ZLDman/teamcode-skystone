...
@Autonomous(name = "red_Blocks_foundaton")

public class Red_Blocks_Foundation_Combo extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        while (homeOntheRange.rawUltrasonic() > 28  && opModeIsActive()){
            driveStraight(0.5);
        ...
        if (leftRangeValue > 85) ///////////////////////////////////
        {
            ...
            //while (leftRange.rawUltrasonic() < 81 && opModeIsActive())
            //strafeLeft(0.5);
            //stopMotors();
        ...
        else if (leftRangeValue > 46)
        {
            ...
            telemetry.addData("From Skystone: ", homeOntheRange.rawUltrasonic());
            telemetry.update();
            backUp = 200;
        }
        ...
        stopMotors();
        driveStraight(1);
        sleep(travelDuration + 800); //time for 4th position is 2000
        stopMotors();
